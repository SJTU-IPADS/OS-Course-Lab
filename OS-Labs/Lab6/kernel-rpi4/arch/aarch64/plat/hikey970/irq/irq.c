...
/* XXX(MK): Doesn't hikey970 support gic-v3? */
...
/*
 * XXX: it should be ensured that cpuid is identical to the bit offset read
 * from GICD_ITARGETSR, which is guaranteed by the sequence of MPIDR in
 * hikey970/smp.c is correct
 */

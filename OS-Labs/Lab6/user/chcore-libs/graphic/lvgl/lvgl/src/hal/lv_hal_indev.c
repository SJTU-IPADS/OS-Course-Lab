...
lv_indev_t* lv_indev_drv_register(lv_indev_drv_t* driver)
{
        ...
        indev->driver->read_timer = lv_timer_create(
                lv_indev_read_timer_cb, LV_INDEV_DEF_READ_PERIOD, indev);
...
void _lv_indev_read(lv_indev_t* indev, lv_indev_data_t* data)
{
        ...
        /*Similarly set at least the last key in case of the user doesn't set it
           on release*/

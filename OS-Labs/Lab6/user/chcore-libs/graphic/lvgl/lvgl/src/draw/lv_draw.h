...
typedef struct _lv_draw_ctx_t {
         ...
         * @param dest_area     get this area of the result image. It assumes
         * that the original image is placed to the 0;0 position.
         ...
         * @param cbuf          place the colors of the pixels on `dest_area`
         * here in RGB format
         * @param abuf          place the opacity of the pixels on `dest_area`
         * here
         */
        void (*draw_transform)(struct _lv_draw_ctx_t* draw_ctx,
                               ...
                               const lv_draw_img_dsc_t* draw_dsc,
                               lv_img_cf_t cf, lv_color_t* cbuf,
                               lv_opa_t* abuf);
        ...
        /**
         * Wait until all background operations are finished. (E.g. GPU
         * operations)
         */
         ...
         * @note dest_area and src_area must be clipped to the real dimensions
         * of the buffers
         */
         ...
         * The original buffer and area data are already saved from `draw_ctx`
         * to `layer_ctx`
         ...
         * `layer_ctx->area_act`. It's called only if flags has

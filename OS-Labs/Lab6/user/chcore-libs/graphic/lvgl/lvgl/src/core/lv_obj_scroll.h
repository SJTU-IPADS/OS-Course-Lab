...
enum { LV_SCROLLBAR_MODE_OFF, /**< Never show scrollbars*/
       LV_SCROLLBAR_MODE_ON, /**< Always show scrollbars*/
       LV_SCROLLBAR_MODE_ACTIVE, /**< Show scroll bars when object is being
                                    scrolled*/
       LV_SCROLLBAR_MODE_AUTO, /**< Show scroll bars when the content is large
 ...
 * scroll stops.*/
enum { LV_SCROLL_SNAP_NONE, /**< Do not align, leave where it is*/

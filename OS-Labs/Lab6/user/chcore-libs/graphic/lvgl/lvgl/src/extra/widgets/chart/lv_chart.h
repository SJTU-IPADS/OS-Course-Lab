 ...
 * Chart types
 */
enum { LV_CHART_TYPE_NONE, /**< Don't draw the series*/
       LV_CHART_TYPE_LINE, /**< Connect the points with lines*/
       LV_CHART_TYPE_BAR, /**< Draw columns*/
       LV_CHART_TYPE_SCATTER, /**< Draw points and lines in 2D (x,y
                                 coordinates)*/
};
 ...
 */
enum { LV_CHART_UPDATE_MODE_SHIFT, /**< Shift old data to the left and add the
                                      new one the right*/
 ...
 */
enum { LV_CHART_AXIS_PRIMARY_Y = 0x00,
...
typedef struct {
        lv_obj_t obj;
        lv_ll_t series_ll; /**< Linked list for the series (stores
                              lv_chart_series_t)*/
        lv_ll_t cursor_ll; /**< Linked list for the cursors (stores
                              lv_chart_cursor_t)*/
 ...
 */
typedef enum {
        LV_CHART_DRAW_PART_DIV_LINE_INIT, /**< Used before/after drawn the div
                                             lines*/
        LV_CHART_DRAW_PART_DIV_LINE_HOR, /**< Used for each horizontal division
                                            lines*/
        LV_CHART_DRAW_PART_DIV_LINE_VER, /**< Used for each vertical division
                                            lines*/
        LV_CHART_DRAW_PART_LINE_AND_POINT, /**< Used on line and scatter charts

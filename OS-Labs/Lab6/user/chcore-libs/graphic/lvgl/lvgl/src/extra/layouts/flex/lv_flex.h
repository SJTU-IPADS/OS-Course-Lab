...
typedef enum {
        ...
        LV_FLEX_FLOW_ROW_WRAP_REVERSE = LV_FLEX_FLOW_ROW | _LV_FLEX_WRAP
                                        | _LV_FLEX_REVERSE,
        ...
        LV_FLEX_FLOW_COLUMN_WRAP_REVERSE = LV_FLEX_FLOW_COLUMN | _LV_FLEX_WRAP
                                           | _LV_FLEX_REVERSE,
} lv_flex_flow_t;
...
{
        lv_style_value_t v =
                lv_obj_get_style_prop(obj, part, LV_STYLE_FLEX_FLOW);
...
{
        lv_style_value_t v =
                lv_obj_get_style_prop(obj, part, LV_STYLE_FLEX_GROW);

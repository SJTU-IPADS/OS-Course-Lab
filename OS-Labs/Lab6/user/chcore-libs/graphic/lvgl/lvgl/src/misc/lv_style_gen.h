...
#define LV_STYLE_CONST_TRANSFORM_WIDTH(val)                  \
        {                                                    \
                .prop = LV_STYLE_TRANSFORM_WIDTH, .value = { \
                        .num = (int32_t)val                  \
                }                                            \
        }
...
#define LV_STYLE_CONST_TRANSFORM_HEIGHT(val)                  \
        {                                                     \
                .prop = LV_STYLE_TRANSFORM_HEIGHT, .value = { \
                        .num = (int32_t)val                   \
                }                                             \
        }
...
#define LV_STYLE_CONST_TRANSFORM_ZOOM(val)                  \
        {                                                   \
                .prop = LV_STYLE_TRANSFORM_ZOOM, .value = { \
                        .num = (int32_t)val                 \
                }                                           \
        }
...
#define LV_STYLE_CONST_TRANSFORM_ANGLE(val)                  \
        {                                                    \
                .prop = LV_STYLE_TRANSFORM_ANGLE, .value = { \
                        .num = (int32_t)val                  \
                }                                            \
        }
...
#define LV_STYLE_CONST_TRANSFORM_PIVOT_X(val)                  \
        {                                                      \
                .prop = LV_STYLE_TRANSFORM_PIVOT_X, .value = { \
                        .num = (int32_t)val                    \
                }                                              \
        }
...
#define LV_STYLE_CONST_TRANSFORM_PIVOT_Y(val)                  \
        {                                                      \
                .prop = LV_STYLE_TRANSFORM_PIVOT_Y, .value = { \
                        .num = (int32_t)val                    \
                }                                              \
        }
...
#define LV_STYLE_CONST_BG_DITHER_MODE(val)                  \
        {                                                   \
                .prop = LV_STYLE_BG_DITHER_MODE, .value = { \
                        .num = (int32_t)val                 \
                }                                           \
        }
...
#define LV_STYLE_CONST_BG_IMG_RECOLOR_OPA(val)                  \
        {                                                       \
                .prop = LV_STYLE_BG_IMG_RECOLOR_OPA, .value = { \
                        .num = (int32_t)val                     \
                }                                               \
        }
...
#define LV_STYLE_CONST_OUTLINE_WIDTH(val)                  \
        {                                                  \
                .prop = LV_STYLE_OUTLINE_WIDTH, .value = { \
                        .num = (int32_t)val                \
                }                                          \
        }
...
#define LV_STYLE_CONST_SHADOW_SPREAD(val)                  \
        {                                                  \
                .prop = LV_STYLE_SHADOW_SPREAD, .value = { \
                        .num = (int32_t)val                \
                }                                          \
        }
...
#define LV_STYLE_CONST_IMG_RECOLOR_OPA(val)                  \
        {                                                    \
                .prop = LV_STYLE_IMG_RECOLOR_OPA, .value = { \
                        .num = (int32_t)val                  \
                }                                            \
        }
...
#define LV_STYLE_CONST_LINE_DASH_WIDTH(val)                  \
        {                                                    \
                .prop = LV_STYLE_LINE_DASH_WIDTH, .value = { \
                        .num = (int32_t)val                  \
                }                                            \
        }
...
#define LV_STYLE_CONST_LINE_DASH_GAP(val)                  \
        {                                                  \
                .prop = LV_STYLE_LINE_DASH_GAP, .value = { \
                        .num = (int32_t)val                \
                }                                          \
        }
...
#define LV_STYLE_CONST_TEXT_LETTER_SPACE(val)                  \
        {                                                      \
                .prop = LV_STYLE_TEXT_LETTER_SPACE, .value = { \
                        .num = (int32_t)val                    \
                }                                              \
        }
...
#define LV_STYLE_CONST_TEXT_LINE_SPACE(val)                  \
        {                                                    \
                .prop = LV_STYLE_TEXT_LINE_SPACE, .value = { \
                        .num = (int32_t)val                  \
                }                                            \
        }
...
#define LV_STYLE_CONST_COLOR_FILTER_OPA(val)                  \
        {                                                     \
                .prop = LV_STYLE_COLOR_FILTER_OPA, .value = { \
                        .num = (int32_t)val                   \
                }                                             \
        }

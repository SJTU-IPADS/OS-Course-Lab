                 ...
                 uint16_t start_angle, uint16_t end_angle)
{
        ...
        //    backend->draw_arc(center_x, center_y, radius, start_angle,
        //    end_angle, clip_area, dsc);
}
        ...
        if (start_quarter == end_quarter && start_angle <= end_angle) {
                if (start_quarter == 0) {
                        area->y1 = y
                                   ...
                                   - extra_area;
                        area->x2 = x
                                   + ((lv_trigo_sin(start_angle + 90) * rout)
                                      >> LV_TRIGO_SHIFT)
                                   + extra_area;

                        area->y2 = y
                                   + ((lv_trigo_sin(end_angle) * rout)
                                      >> LV_TRIGO_SHIFT)
                                   + extra_area;
                        area->x1 = x
                                   + ((lv_trigo_sin(end_angle + 90) * rin)
                                      >> LV_TRIGO_SHIFT)
                                   - extra_area;
                } else if (start_quarter == 1) {
                        area->y2 = y
                                   + ((lv_trigo_sin(start_angle) * rout)
                                      >> LV_TRIGO_SHIFT)
                                   + extra_area;
                        area->x2 = x
                                   + ((lv_trigo_sin(start_angle + 90) * rin)
                                      >> LV_TRIGO_SHIFT)
                                   + extra_area;

                        area->y1 = y
                                   + ((lv_trigo_sin(end_angle) * rin)
                                      >> LV_TRIGO_SHIFT)
                                   - extra_area;
                        area->x1 = x
                                   + ((lv_trigo_sin(end_angle + 90) * rout)
                                      >> LV_TRIGO_SHIFT)
                                   - extra_area;
                ...
                area->x1 = x
                           ...
                           - extra_area;
                area->y1 = y
                           + ((LV_MIN(lv_trigo_sin(end_angle),
                                      lv_trigo_sin(start_angle))
                               * rin)
                              >> LV_TRIGO_SHIFT)
                           - extra_area;
                area->x2 = x
                ...
                area->y1 =
                        y + ((lv_trigo_sin(end_angle) * rout) >> LV_TRIGO_SHIFT)
                        - extra_area;
                area->x2 = x
                           + ((LV_MAX(lv_trigo_sin(start_angle + 90),
                                      lv_trigo_sin(end_angle + 90))
                               * rin)
                              >> LV_TRIGO_SHIFT)
                           + extra_area;
                area->y2 =
                        y
                        + ((lv_trigo_sin(start_angle) * rout) >> LV_TRIGO_SHIFT)
                        + extra_area;
                ...
                area->x1 = x
                           + ((LV_MIN(lv_trigo_sin(end_angle + 90),
                                      lv_trigo_sin(start_angle + 90))
                               * rin)
                              >> LV_TRIGO_SHIFT)
                           - extra_area;
                area->y1 =

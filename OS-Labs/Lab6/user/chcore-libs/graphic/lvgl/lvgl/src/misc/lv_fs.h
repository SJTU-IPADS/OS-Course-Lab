 ...
 */
typedef enum {
        LV_FS_SEEK_SET = 0x00, /**< Set the position from absolutely (from the
                                  start of file)*/
...
typedef struct _lv_fs_drv_t {
        ...
        lv_fs_res_t (*read_cb)(struct _lv_fs_drv_t* drv, void* file_p,
                               void* buf, uint32_t btr, uint32_t* br);
        lv_fs_res_t (*write_cb)(struct _lv_fs_drv_t* drv, void* file_p,
                                const void* buf, uint32_t btw, uint32_t* bw);
        lv_fs_res_t (*seek_cb)(struct _lv_fs_drv_t* drv, void* file_p,
        ...
        lv_fs_res_t (*dir_read_cb)(struct _lv_fs_drv_t* drv, void* rddir_p,
                                   char* fn);

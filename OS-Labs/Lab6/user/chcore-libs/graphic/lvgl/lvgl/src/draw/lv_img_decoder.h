...
/**
 * Source of image.*/
enum { LV_IMG_SRC_VARIABLE, /** Binary/C variable*/
...
typedef struct _lv_img_decoder_dsc_t {
        ...
        /**Type of the source: file or variable. Can be set in `open` function
         * if required*/
        ...
        /**A text to display instead of the image when the image can't be
         * opened. Can be set in `open` function or set NULL.*/

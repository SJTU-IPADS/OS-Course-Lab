 ...
 * parameter.
 * It's more consistent but less convenient. Might be used by binding generator
 * functions.*/
...
typedef struct _lv_anim_t {
        ...
        lv_anim_deleted_cb_t deleted_cb; /**< Call it when the animation is
                                            deleted*/
        lv_anim_get_value_cb_t get_value_cb; /**< Get the current value in
                                                relative mode*/
#if LV_USE_USER_DATA
        void *user_data; /**< Custom user data*/
#endif
        lv_anim_path_cb_t path_cb; /**< Describe the path (curve) of
                                      animations*/
        ...
        int32_t act_time; /**< Current time in animation. Set to negative to
                             make delay.*/
        ...
        uint8_t early_apply : 1; /**< 1: Apply start value immediately even is
                                    there is `delay`*/

        /*Animation system use these - user shouldn't set*/
        uint8_t playback_now : 1; /**< Play back is in progress*/
        uint8_t run_round : 1; /**< Indicates the animation has run in this
                                  round*/
        uint8_t start_cb_called : 1; /**< Indicates that the `start_cb` was
                                        already called*/
} lv_anim_t;
 ...
 */
static inline void lv_anim_set_get_value_cb(lv_anim_t *a,

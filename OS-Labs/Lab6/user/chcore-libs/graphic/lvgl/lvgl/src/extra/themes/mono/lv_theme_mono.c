        ...
        if (lv_obj_check_type(obj, &lv_obj_class)) {
                ...
                if (lv_obj_check_type(lv_obj_get_parent(obj),
                        ...
                        lv_obj_add_style(obj,
                                         ...
                                         LV_PART_ITEMS | LV_STATE_DISABLED);
                        lv_obj_add_style(
                                obj, &styles->focus, LV_STATE_FOCUS_KEY);
                        lv_obj_add_style(obj,
                                         &styles->underline,
                                         LV_PART_ITEMS | LV_STATE_FOCUS_KEY);
                        lv_obj_add_style(obj,
                ...
                lv_obj_add_style(obj, &styles->card, LV_PART_ITEMS);
                lv_obj_add_style(
                        obj, &styles->pr, LV_PART_ITEMS | LV_STATE_PRESSED);
                lv_obj_add_style(
                        obj, &styles->inv, LV_PART_ITEMS | LV_STATE_CHECKED);
                lv_obj_add_style(obj,
                                 &styles->disabled,
                                 LV_PART_ITEMS | LV_STATE_DISABLED);
                lv_obj_add_style(obj,
                ...
                lv_obj_add_style(obj, &styles->focus, LV_STATE_FOCUS_KEY);
                lv_obj_add_style(
                        obj, &styles->inv, LV_PART_ITEMS | LV_STATE_FOCUS_KEY);
                lv_obj_add_style(obj, &styles->edit, LV_STATE_EDITED);
        }
#endif
                ...
                lv_obj_add_style(
                        obj, &styles->pr, LV_PART_INDICATOR | LV_STATE_PRESSED);
                lv_obj_add_style(obj, &styles->focus, LV_STATE_FOCUS_KEY);
                lv_obj_add_style(obj, &styles->edit, LV_STATE_EDITED);
        }
#endif
                ...
                lv_obj_add_style(obj, &styles->inv, LV_PART_INDICATOR);
                lv_obj_add_style(
                        obj, &styles->radius_circle, LV_PART_INDICATOR);
                lv_obj_add_style(obj, &styles->card, LV_PART_KNOB);
                lv_obj_add_style(obj, &styles->radius_circle, LV_PART_KNOB);
                ...
                lv_obj_add_style(obj, &styles->scrollbar, LV_PART_SCROLLBAR);
                lv_obj_add_style(
                        obj, &styles->inv, LV_PART_SELECTED | LV_STATE_CHECKED);
                lv_obj_add_style(
                        obj, &styles->pr, LV_PART_SELECTED | LV_STATE_PRESSED);
                lv_obj_add_style(obj, &styles->focus, LV_STATE_FOCUS_KEY);
                lv_obj_add_style(obj, &styles->edit, LV_STATE_EDITED);
        }
#endif

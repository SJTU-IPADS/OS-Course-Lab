...
typedef struct {
        ...
        uint8_t round_end : 1;
        uint8_t raw_end : 1; /*Do not bother with perpendicular line ending if
                                it's not visible for any reason*/
} lv_draw_line_dsc_t;
 ...
 */
void /* LV_ATTRIBUTE_FAST_MEM */ lv_draw_line(struct _lv_draw_ctx_t* draw_ctx,

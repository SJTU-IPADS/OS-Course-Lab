...
#define TEST_ASSERT_BITS_HIGH(mask, actual) \
        UNITY_TEST_ASSERT_BITS(             \
                (mask), (UNITY_UINT)(-1), (actual), __LINE__, NULL)
#define TEST_ASSERT_BITS_LOW(mask, actual) \
        UNITY_TEST_ASSERT_BITS(            \
                (mask), (UNITY_UINT)(0), (actual), __LINE__, NULL)
#define TEST_ASSERT_BIT_HIGH(bit, actual)                \
        UNITY_TEST_ASSERT_BITS(((UNITY_UINT)1 << (bit)), \
                               (UNITY_UINT)(-1),         \
                               (actual),                 \
                               __LINE__,                 \
                               NULL)
...
#define TEST_ASSERT_NOT_EQUAL_UINT64(threshold, actual) \
        UNITY_TEST_ASSERT_NOT_EQUAL_UINT64(             \
                (threshold), (actual), __LINE__, NULL)
...
#define TEST_ASSERT_NOT_EQUAL(expected, actual) \
        UNITY_TEST_ASSERT(                      \
                ((expected) != (actual)), __LINE__, " Expected Not-Equal")
#endif
...
#define TEST_ASSERT_EQUAL_UINT16_MESSAGE(expected, actual, message) \
        UNITY_TEST_ASSERT_EQUAL_UINT16(                             \
                (expected), (actual), __LINE__, (message))
...
#define TEST_ASSERT_BITS_MESSAGE(mask, expected, actual, message) \
        UNITY_TEST_ASSERT_BITS(                                   \
                (mask), (expected), (actual), __LINE__, (message))
...
#define TEST_ASSERT_NOT_EQUAL_INT64_MESSAGE(threshold, actual, message) \
        UNITY_TEST_ASSERT_NOT_EQUAL_INT64(                              \
                (threshold), (actual), __LINE__, (message))
...
#define TEST_ASSERT_NOT_EQUAL_HEX64_MESSAGE(threshold, actual, message) \
        UNITY_TEST_ASSERT_NOT_EQUAL_HEX64(                              \
                (threshold), (actual), __LINE__, (message))
...
#define TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(            \
        ...
        UNITY_TEST_ASSERT_INT_ARRAY_WITHIN((delta),      \
                                           (expected),   \
                                           (actual),     \
                                           num_elements, \
                                           __LINE__,     \
...
#define TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)   \
        UNITY_TEST_ASSERT_INT8_ARRAY_WITHIN((delta),      \
                                            (expected),   \
                                            (actual),     \
                                            num_elements, \
                                            __LINE__,     \
...
#define TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_INT16_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_INT32_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_INT32_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_INT64_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)   \
        UNITY_TEST_ASSERT_UINT_ARRAY_WITHIN((delta),      \
                                            (expected),   \
                                            (actual),     \
                                            num_elements, \
                                            __LINE__,     \
...
#define TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_UINT8_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)     \
        UNITY_TEST_ASSERT_UINT16_ARRAY_WITHIN((delta),      \
                                              (expected),   \
                                              (actual),     \
                                              num_elements, \
                                              __LINE__,     \
...
#define TEST_ASSERT_UINT32_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)     \
        UNITY_TEST_ASSERT_UINT32_ARRAY_WITHIN((delta),      \
                                              (expected),   \
                                              (actual),     \
                                              num_elements, \
                                              __LINE__,     \
...
#define TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)     \
        UNITY_TEST_ASSERT_UINT64_ARRAY_WITHIN((delta),      \
                                              (expected),   \
                                              (actual),     \
                                              num_elements, \
                                              __LINE__,     \
...
#define TEST_ASSERT_HEX_ARRAY_WITHIN_MESSAGE(              \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_HEX32_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)   \
        UNITY_TEST_ASSERT_HEX8_ARRAY_WITHIN((delta),      \
                                            (expected),   \
                                            (actual),     \
                                            num_elements, \
                                            __LINE__,     \
...
#define TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_HEX16_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_HEX64_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)    \
        UNITY_TEST_ASSERT_HEX64_ARRAY_WITHIN((delta),      \
                                             (expected),   \
                                             (actual),     \
                                             num_elements, \
                                             __LINE__,     \
...
#define TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(            \
        delta, expected, actual, num_elements, message)   \
        UNITY_TEST_ASSERT_CHAR_ARRAY_WITHIN((delta),      \
                                            (expected),   \
                                            (actual),     \
                                            num_elements, \
                                            __LINE__,     \
...
#define TEST_ASSERT_EQUAL_MEMORY_ARRAY_MESSAGE(              \
        ...
        UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY((expected),     \
                                             (actual),       \
                                             (len),          \
                                             (num_elements), \
                                             __LINE__,       \
...
#define TEST_ASSERT_EACH_EQUAL_MEMORY_MESSAGE(              \
        expected, actual, len, num_elements, message)       \
        UNITY_TEST_ASSERT_EACH_EQUAL_MEMORY((expected),     \
                                            (actual),       \
                                            (len),          \
                                            (num_elements), \
                                            __LINE__,       \

...
void test_bar_should_update_indicator_right_coordinate_based_on_bar_value(void)
{
        ...
        int32_t expected_coord =
                (bar_value * indicator_part_width) / bar_max_value;
        ...
        void)
{
        ...
        lv_coord_t right_padding =
                lv_obj_get_style_pad_right(bar, LV_PART_MAIN);
        ...
        void)
{
        ...
        TEST_ASSERT_EQUAL_INT32(lv_bar_get_value(bar),

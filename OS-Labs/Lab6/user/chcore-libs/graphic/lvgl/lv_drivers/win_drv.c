...
static void win_drv_flush(lv_disp_t *drv, lv_area_t *area,
                          const lv_color_t *color_p);
static void win_drv_fill(int32_t x1, int32_t y1, int32_t x2, int32_t y2,
                         lv_color_t color);
static void win_drv_map(int32_t x1, int32_t y1, int32_t x2, int32_t y2,
                        const lv_color_t *color_p);
...
HWND windrv_init(void)
{
        ...
        lvgl_icon = (HICON)LoadImage(
                NULL, "lvgl_icon.bmp", IMAGE_ICON, 0, 0, LR_LOADFROMFILE);
...
static void do_register(void)
{
        ...
        lv_disp_draw_buf_init(&disp_draw_buf_1,
                              buf1_1,
                              NULL,
                              WINDOW_HOR_RES * 100); /*Initialize the display
                                                        buffer*/

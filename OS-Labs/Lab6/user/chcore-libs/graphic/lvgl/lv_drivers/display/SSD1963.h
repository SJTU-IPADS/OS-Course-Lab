...
#define CMD_GET_ADDR_MODE \
        0x0B // Get the frame memory to the display panel read order
...
#define CMD_SET_TEAR_OFF \
        0x34 // synchronization information is not sent from the display
#define CMD_SET_TEAR_ON 0x35 // sync. information is sent from the display
#define CMD_SET_ADDR_MODE \
        0x36 // set fram buffer read order to the display
             // panel

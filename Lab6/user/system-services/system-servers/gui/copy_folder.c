...
// If you want to use your own cursor theme, please uncomment this function and the former one.
// And you have to do following:
// 1. Copy your cursor theme to ramdisk
// 2. Modify the path in the call of this function in gui.srv
// 3. Use wayland cursor interfaces.

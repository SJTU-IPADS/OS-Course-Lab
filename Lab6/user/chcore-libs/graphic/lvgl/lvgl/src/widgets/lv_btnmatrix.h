...
enum { _LV_BTNMATRIX_WIDTH = 0x000F, /**< Reserved to store the size units*/
       LV_BTNMATRIX_CTRL_HIDDEN = 0x0010, /**< Button hidden*/
       LV_BTNMATRIX_CTRL_NO_REPEAT = 0x0020, /**< Do not repeat press this
                                                button.*/
       LV_BTNMATRIX_CTRL_DISABLED = 0x0040, /**< Disable this button.*/
       LV_BTNMATRIX_CTRL_CHECKABLE = 0x0080, /**< The button can be toggled.*/
       LV_BTNMATRIX_CTRL_CHECKED = 0x0100, /**< Button is currently toggled
                                              (e.g. checked).*/
       LV_BTNMATRIX_CTRL_CLICK_TRIG = 0x0200, /**< 1: Send LV_EVENT_VALUE_CHANGE
                                                 on CLICK, 0: Send
                                                 LV_EVENT_VALUE_CHANGE on
                                                 PRESS*/
       LV_BTNMATRIX_CTRL_POPOVER = 0x0400, /**< Show a popover when pressing
                                              this key*/
       LV_BTNMATRIX_CTRL_RECOLOR = 0x0800, /**< Enable text recoloring with
                                              `#color`*/
...
typedef struct {
        ...
        uint16_t btn_cnt; /*Number of button in 'map_p'(Handled by the
                             library)*/
        uint16_t row_cnt; /*Number of rows in 'map_p'(Handled by the library)*/
        uint16_t btn_id_sel; /*Index of the active button (being
                                pressed/released etc) or LV_BTNMATRIX_BTN_NONE*/

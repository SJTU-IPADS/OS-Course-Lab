...
typedef enum {
        _LV_STYLE_STATE_CMP_SAME, /*The style properties in the 2 states are
                                     identical*/
        _LV_STYLE_STATE_CMP_DIFF_REDRAW, /*The differences can be shown with a
                                            simple redraw*/
        _LV_STYLE_STATE_CMP_DIFF_DRAW_PAD, /*The differences can be shown with a
                                              simple redraw*/
        _LV_STYLE_STATE_CMP_DIFF_LAYOUT, /*The differences can be shown with a
                                            simple redraw*/
...
lv_obj_get_style_transform_zoom_safe(const struct _lv_obj_t* obj, uint32_t part)
{
 ...
 * @param part      the part whose opacity should be get. Non-MAIN parts will
 * consider the `opa` of teh MAIN part too
 * @return          the final opacity considering the parents' opacity too
 */
lv_opa_t lv_obj_get_style_opa_recursive(const struct _lv_obj_t* obj,
                                        lv_part_t part);

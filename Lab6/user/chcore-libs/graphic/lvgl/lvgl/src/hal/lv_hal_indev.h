...
typedef enum {
        ...
        LV_INDEV_TYPE_BUTTON, /**< External (hardware button) which is assigned
                                 to a specific point of the screen*/
...
typedef struct _lv_indev_drv_t {
        ...
        /**< At least this difference should be between two points to evaluate
         * as gesture*/
...
typedef struct _lv_indev_proc_t {
        ...
        union {
                struct {
                        ...
                        lv_point_t act_point; /**< Current point of input
                                                 device.*/
                        lv_point_t indev_point;
                        lv_point_t last_point; /**< Last point of input
                                                  device.*/
                        lv_point_t last_raw_point; /**< Last point read from
                                                      read_cb. */
                        lv_point_t vect; /**< Difference between `act_point` and
                                            `last_point`.*/
                        lv_point_t scroll_sum; /*Count the dragged pixels to
                                                  check
                                                  LV_INDEV_DEF_SCROLL_LIMIT*/
                        lv_point_t scroll_throw_vect;
                        lv_point_t scroll_throw_vect_ori;
                        struct _lv_obj_t *act_obj; /*The object being pressed*/
                        struct _lv_obj_t *last_obj; /*The last object which was
                                                       pressed*/
                        struct _lv_obj_t *scroll_obj; /*The object being
                                                         scrolled*/
                        struct _lv_obj_t *last_pressed; /*The lastly pressed
                                                           object*/
                        lv_area_t scroll_area;

                        lv_point_t gesture_sum; /*Count the gesture pixels to
                                                   check
...
typedef struct _lv_indev_t {
        ...
        const lv_point_t *btn_points; /**< Array points assigned to the button
                                         ()screen will be pressed here by the
                                         buttons*/
} lv_indev_t;

...
#define LV_LOG_TRACE(...) \
        _lv_log_add(      \
                LV_LOG_LEVEL_TRACE, __FILE__, __LINE__, __func__, __VA_ARGS__)
#else
#define LV_LOG_TRACE(...) \
        do {              \
        } while (0)
...
#define LV_LOG_INFO(...) \
        _lv_log_add(     \
                LV_LOG_LEVEL_INFO, __FILE__, __LINE__, __func__, __VA_ARGS__)
#else
#define LV_LOG_INFO(...) \
        do {             \
        } while (0)
...
#define LV_LOG_WARN(...) \
        _lv_log_add(     \
                LV_LOG_LEVEL_WARN, __FILE__, __LINE__, __func__, __VA_ARGS__)
#else
#define LV_LOG_WARN(...) \
        do {             \
        } while (0)
...
#define LV_LOG_ERROR(...) \
        _lv_log_add(      \
                LV_LOG_LEVEL_ERROR, __FILE__, __LINE__, __func__, __VA_ARGS__)
#else
#define LV_LOG_ERROR(...) \
        do {              \
        } while (0)
...
#define LV_LOG_USER(...) \
        _lv_log_add(     \
                LV_LOG_LEVEL_USER, __FILE__, __LINE__, __func__, __VA_ARGS__)
#else
#define LV_LOG_USER(...) \
        do {             \
        } while (0)

                             ...
                             lv_img_header_t* header)
{
        ...
        if (src_type == LV_IMG_SRC_FILE) {
                const char* fn = src;
                if (strcmp(lv_fs_get_ext(fn), "bmp") == 0) { /*Check the
                                                                extension*/
                        ...
                        header->cf = bpp == 32 ? LV_IMG_CF_TRUE_COLOR_ALPHA :
                             ...
                             lv_img_decoder_dsc_t* dsc)
{
        ...
        if (dsc->src_type == LV_IMG_SRC_FILE) {
                ...
                if (LV_COLOR_DEPTH == 32 && (b.bpp != 32 && b.bpp != 24)) {
                        LV_LOG_WARN(
                                "LV_COLOR_DEPTH == 32 but bpp is %d (should be 32 or 24)",
                                b.bpp);
                        color_depth_error = true;
                } else if (LV_COLOR_DEPTH == 16 && b.bpp != 16) {
                        LV_LOG_WARN(
                                "LV_COLOR_DEPTH == 16 but bpp is %d (should be 16)",
                                b.bpp);
                        color_depth_error = true;
                } else if (LV_COLOR_DEPTH == 8 && b.bpp != 8) {
                        LV_LOG_WARN(
                                "LV_COLOR_DEPTH == 8 but bpp is %d (should be 8)",
                                b.bpp);
                        color_depth_error = true;
                }

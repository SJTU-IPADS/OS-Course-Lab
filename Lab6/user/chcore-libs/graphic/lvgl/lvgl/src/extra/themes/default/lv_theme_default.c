...
#if LV_USE_MENU
        lv_style_t menu_bg, menu_cont, menu_sidebar_cont, menu_main_cont,
                menu_page, menu_header_cont, menu_header_btn, menu_section,
                menu_pressed, menu_separator;
#endif
                                 ...
                                 lv_color_t color, lv_opa_t opa)
{
        ...
        if (theme.flags & MODE_DARK)
                return lv_color_mix(
                        lv_palette_darken(LV_PALETTE_GREY, 2), color, opa);
        else
                return lv_color_mix(
                        lv_palette_lighten(LV_PALETTE_GREY, 2), color, opa);
}
...
static void style_init(void)
{
        ...
        color_text = theme.flags & MODE_DARK ? DARK_COLOR_TEXT :
                                               LIGHT_COLOR_TEXT;
        color_card = theme.flags & MODE_DARK ? DARK_COLOR_CARD :
                                               LIGHT_COLOR_CARD;
        color_grey = theme.flags & MODE_DARK ? DARK_COLOR_GREY :
                                               LIGHT_COLOR_GREY;
        ...
        lv_style_transition_dsc_init(&trans_delayed,
                                     trans_props,
                                     lv_anim_path_linear,
                                     TRANSITION_TIME,
                                     70,
        ...
        lv_style_transition_dsc_init(&trans_normal,
                                     trans_props,
                                     lv_anim_path_linear,
                                     TRANSITION_TIME,
                                     0,
        ...
        lv_style_set_transition(&styles->transition_delayed,
                                &trans_delayed); /*Go back to default state with
                                                    delay*/

        lv_style_set_transition(&styles->transition_normal,
                                &trans_normal); /*Go back to default state with
                                                   delay*/
#endif
        ...
        lv_style_set_line_color(&styles->card,
                                lv_palette_main(LV_PALETTE_GREY));
        ...
        lv_style_set_outline_color(&styles->outline_secondary,
        ...
        if (!(theme.flags & MODE_DARK)) {
                lv_style_set_shadow_color(&styles->btn,
                                          lv_palette_main(LV_PALETTE_GREY));
                lv_style_set_shadow_width(&styles->btn, LV_DPX(3));
                lv_style_set_shadow_opa(&styles->btn, LV_OPA_50);
                lv_style_set_shadow_ofs_y(&styles->btn,
                                          lv_disp_dpx(theme.disp, LV_DPX(4)));
        }
        ...
        lv_style_set_text_align(&styles->text_align_center,
        ...
        lv_style_set_bg_color(&styles->bg_color_primary_muted,
                              theme.color_primary);
        lv_style_set_text_color(&styles->bg_color_primary_muted,
                                theme.color_primary);
        ...
        lv_style_set_transform_height(&styles->grow,
        ...
        lv_style_set_line_width(&styles->chart_series,
                                lv_disp_dpx(theme.disp, 3));
        ...
        lv_style_set_pad_column(&styles->chart_series,
                                lv_disp_dpx(theme.disp, 2));
        ...
        lv_style_set_line_width(&styles->chart_ticks,
        ...
        lv_style_set_border_width(&styles->menu_cont,
                                  lv_disp_dpx(theme.disp, 1));
        ...
        lv_style_set_border_side(&styles->menu_sidebar_cont,
        ...
        lv_style_set_line_width(&styles->meter_marker,
                                lv_disp_dpx(theme.disp, 5));
        lv_style_set_line_color(&styles->meter_marker, color_text);
        lv_style_set_size(&styles->meter_marker, lv_disp_dpx(theme.disp, 20));
        lv_style_set_pad_left(&styles->meter_marker,
                              lv_disp_dpx(theme.disp, 15));
        ...
        lv_style_set_border_width(&styles->table_cell,
                                  lv_disp_dpx(theme.disp, 1));
        ...
        lv_style_set_border_width(&styles->ta_cursor,
                                  lv_disp_dpx(theme.disp, 2));
        ...
        lv_style_set_arc_width(&styles->colorwheel_main,
                               lv_disp_dpx(theme.disp, 10));
#endif
        ...
        lv_style_set_pad_all(&styles->msgbox_btn_bg,
        ...
        lv_style_set_radius(&styles->keyboard_btn_bg,
                            disp_size == DISP_SMALL ? RADIUS_DEFAULT / 2 :
                                                      RADIUS_DEFAULT);
#endif
        ...
        lv_style_set_border_width(&styles->list_btn,
                                  lv_disp_dpx(theme.disp, 1));
        ...
        lv_style_set_bg_grad_color(&styles->led,
                                   lv_palette_main(LV_PALETTE_GREY));
                                  ...
                                  const lv_font_t *font)
{
        ...
        if (!lv_theme_default_is_inited()) {
                ...
                styles = (my_theme_styles_t *)LV_GC_ROOT(
                        _lv_theme_default_styles);
        }
...
static void theme_apply(lv_theme_t *th, lv_obj_t *obj)
{
        ...
        if (lv_obj_check_type(obj, &lv_obj_class)) {
                ...
                /*Tabview pages*/
                else if (lv_obj_check_type(lv_obj_get_parent(parent),
                                           &lv_tabview_class)) {
                        lv_obj_add_style(obj, &styles->pad_normal, 0);
                        lv_obj_add_style(
                                obj, &styles->scrollbar, LV_PART_SCROLLBAR);
                        lv_obj_add_style(obj,
                                         &styles->scrollbar_scrolled,
                                         LV_PART_SCROLLBAR | LV_STATE_SCROLLED);
                        return;
                ...
                lv_obj_add_style(
                        obj, &styles->transition_normal, LV_STATE_PRESSED);
                lv_obj_add_style(
                        obj, &styles->outline_primary, LV_STATE_FOCUS_KEY);
#if LV_THEME_DEFAULT_GROW
                lv_obj_add_style(obj, &styles->grow, LV_STATE_PRESSED);
#endif
                lv_obj_add_style(
                        obj, &styles->bg_color_secondary, LV_STATE_CHECKED);
                ...
                if (lv_obj_check_type(lv_obj_get_parent(obj),
                    ...
                    || lv_obj_check_type(lv_obj_get_parent(obj),
                        ...
                        lv_obj_add_style(
                                obj, &styles->menu_pressed, LV_STATE_PRESSED);
                }
#endif
        }
#endif
                ...
                if (lv_obj_check_type(lv_obj_get_parent(obj),
                        ...
                        lv_obj_add_style(obj,
                                         &styles->bg_color_primary_muted,
                                         LV_PART_ITEMS | LV_STATE_FOCUS_KEY);
                        lv_obj_add_style(obj,
                                         &styles->bg_color_secondary_muted,
                ...
                if (lv_obj_check_type(lv_obj_get_parent(obj),
                        ...
                        lv_obj_add_style(obj,
                                         ...
                                         LV_STATE_FOCUS_KEY);
                        lv_obj_add_style(
                                obj, &styles->tab_bg_focus, LV_STATE_FOCUS_KEY);
                        lv_obj_add_style(obj,
                                         &styles->pressed,
                                         LV_PART_ITEMS | LV_STATE_PRESSED);
                        lv_obj_add_style(obj,
                ...
                if (lv_obj_check_type(lv_obj_get_parent(obj),
                        ...
                        lv_obj_add_style(obj,
                                         ...
                                         LV_STATE_EDITED);
                        lv_obj_add_style(
                                obj, &styles->calendar_btnm_day, LV_PART_ITEMS);
                        lv_obj_add_style(obj,
                                         &styles->pressed,
                                         LV_PART_ITEMS | LV_STATE_PRESSED);
                        lv_obj_add_style(obj,
                ...
                lv_obj_add_style(
                        obj, &styles->outline_secondary, LV_STATE_EDITED);
                lv_obj_add_style(
                        obj, &styles->bg_color_primary, LV_PART_INDICATOR);
...
#if LV_THEME_DEFAULT_GROW
                lv_obj_add_style(
                        obj, &styles->grow, LV_PART_KNOB | LV_STATE_PRESSED);
#endif
                lv_obj_add_style(
                        obj, &styles->transition_delayed, LV_PART_KNOB);
                lv_obj_add_style(obj,
                ...
                lv_obj_add_style(obj,
                                 ...
                                 LV_PART_INDICATOR | LV_STATE_PRESSED);
                lv_obj_add_style(
                        obj, &styles->transition_delayed, LV_PART_INDICATOR);
        }
#endif
                ...
                lv_obj_add_style(obj,
                                 ...
                                 LV_PART_INDICATOR | LV_STATE_CHECKED);
                lv_obj_add_style(
                        obj, &styles->transition_normal, LV_PART_INDICATOR);
        }
#endif
                ...
                lv_obj_add_style(
                        obj, &styles->outline_secondary, LV_STATE_EDITED);
                lv_obj_add_style(
                        obj, &styles->bg_color_primary, LV_PART_SELECTED);
        }
#endif
                ...
                lv_obj_add_style(
                        obj, &styles->arc_indic_primary, LV_PART_INDICATOR);
                lv_obj_add_style(obj, &styles->knob, LV_PART_KNOB);
        }
#endif
                ...
                lv_obj_add_style(obj, &styles->scr, 0);
                lv_obj_add_style(obj,
                                 disp_size == DISP_LARGE ? &styles->pad_small :
                                                           &styles->pad_tiny,
                                 0);
                lv_obj_add_style(
                        obj, &styles->outline_primary, LV_STATE_FOCUS_KEY);
                ...
                lv_obj_add_style(
                        obj, &styles->bg_color_primary, LV_STATE_FOCUS_KEY);
                lv_obj_add_style(
                        obj, &styles->list_item_grow, LV_STATE_FOCUS_KEY);
                lv_obj_add_style(
                        obj, &styles->list_item_grow, LV_STATE_PRESSED);
                lv_obj_add_style(obj, &styles->pressed, LV_STATE_PRESSED);
                ...
                lv_obj_add_style(
                        obj, &styles->bg_color_primary_muted, LV_STATE_CHECKED);
                lv_obj_add_style(
                        obj, &styles->bg_color_primary, LV_STATE_FOCUS_KEY);
                ...
                lv_obj_add_style(
                        obj, &styles->outline_secondary, LV_STATE_EDITED);
                lv_obj_add_style(
                        obj, &styles->bg_color_primary, LV_PART_CURSOR);
        }
#endif
#if LV_USE_TILEVIEW

...
typedef enum {
         ...
         * the focus goes to the object in the next/previous row (on left/right
         * keys) or first/last row (on up/down keys)
         */
        LV_GRIDNAV_CTRL_ROLLOVER = 0x1,

        /**
         * If an arrow is pressed and the focused object can be scrolled in that
         * direction then it will be scrolled instead of going to the
         * next/previous object. If there is no more room for scrolling the

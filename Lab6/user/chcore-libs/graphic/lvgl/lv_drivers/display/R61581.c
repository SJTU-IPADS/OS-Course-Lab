...
void r61581_flush(int32_t x1, int32_t y1, int32_t x2, int32_t y2,
                  const lv_color_t *color_p)
{
        ...
        if (y2 < 0)
                return;
        if (x1 > R61581_HOR_RES - 1)
                return;
        if (y1 > R61581_VER_RES - 1)
                return;
...
void r61581_fill(int32_t x1, int32_t y1, int32_t x2, int32_t y2,
                 lv_color_t color)
{
        /*Return if the area is out the screen*/
        if (x2 < 0)
...
void r61581_map(int32_t x1, int32_t y1, int32_t x2, int32_t y2,
                const lv_color_t *color_p)
{
        /*Return if the area is out the screen*/
        if (x2 < 0)
...
static void r61581_set_tft_spec(void)
{
        ...
        /*Interface Setting*/
        r61581_cmd(0xC6);
        r61581_data((R61581_DPL << 0) | (R61581_EPL << 1) | (R61581_HSPL << 4)
                    | (R61581_VSPL << 5));

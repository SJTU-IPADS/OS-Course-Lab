...
static inline void
shl_htable_clear_ulong(struct shl_htable *htable,
		       void (*cb)(unsigned long *elem, void *ctx), void *ctx)
{
	shl_htable_clear(htable, (void (*)(void *, void *))cb, ctx);
}

static inline void
shl_htable_visit_ulong(struct shl_htable *htable,
		       void (*cb)(unsigned long *elem, void *ctx), void *ctx)
{
...
static inline bool shl_htable_lookup_ulong(struct shl_htable *htable,
					   ...
					   unsigned long **out)
{
	return shl_htable_lookup(
		htable, (const void *)&key, (size_t)key, (void **)out);
}
...
#define SHL_HTABLE_INIT_STR(_obj) \
	SHL_HTABLE_INIT(          \
		(_obj), shl_htable_compare_str, shl_htable_rehash_str, NULL)

static inline void shl_htable_init_str(struct shl_htable *htable)
{
	shl_htable_init(
		htable, shl_htable_compare_str, shl_htable_rehash_str, NULL);
}

static inline void shl_htable_clear_str(struct shl_htable *htable,
					void (*cb)(char **elem, void *ctx),
					void *ctx)
{
	shl_htable_clear(htable, (void (*)(void *, void *))cb, ctx);
}
...
static inline int shl_htable_insert_str(struct shl_htable *htable, char **str,
					size_t *hash)
{
	size_t h;

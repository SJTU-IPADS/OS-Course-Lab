...
typedef void (*llog_submit_t)(void *data, const char *file, int line,
			      const char *func, const char *subs,
			      unsigned int sev, const char *format,
			      va_list args);

static inline __attribute__((format(printf, 8, 9))) void
llog_format(llog_submit_t llog, void *data, const char *file, int line,
...
llog_dummyf(llog_submit_t llog, void *data, unsigned int sev,
	    const char *format, ...)
{
}
...
#define llog_EPIPE(obj)         (llog_dEPIPE((obj)->llog, (obj)->llog_data))
...
#define llog_ERRNO(obj)         (llog_dERRNO((obj)->llog, (obj)->llog_data))
...
#define llog_dERR(obj, data, _r)                                      \
	(errno = -(_r),                                               \
	 llog_derror((obj), (data), "syscall failed (%d): %m", (_r)), \
	 (_r))
#define llog_ERR(obj, _r)         (llog_dERR((obj)->llog, (obj)->llog_data, (_r)))
#define llog_vERR(obj, _r)        ((void)llog_ERR((obj), (_r)))
#define llog_vdERR(obj, data, _r) ((void)llog_dERR((obj), (data), (_r)))

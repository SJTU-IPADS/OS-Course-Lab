...
{
	TDWHCIFrameSchedulerNonPeriodic *pThis =
		(TDWHCIFrameSchedulerNonPeriodic *)pBase;
	assert(pThis != 0);
...
void DWHCIFrameSchedulerNonPeriodicTransactionComplete(
	TDWHCIFrameScheduler *pBase, u32 nStatus)
{
	TDWHCIFrameSchedulerNonPeriodic *pThis =
		(TDWHCIFrameSchedulerNonPeriodic *)pBase;
	assert(pThis != 0);

...
#define ARMV6MMUL1SECTION_NORMAL \
	0x0040E // outer and inner write back, no write allocate
...
#if RASPPI == 1
#define ARM_AUX_CONTROL_CACHE_SIZE \
	(1 << 6) // restrict cache size to 16K (no page coloring)
#else

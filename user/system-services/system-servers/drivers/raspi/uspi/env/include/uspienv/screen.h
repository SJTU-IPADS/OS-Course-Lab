...
int ScreenDeviceWrite(TScreenDevice *pThis, const void *pBuffer,
		      unsigned nCount);

void ScreenDeviceSetPixel(TScreenDevice *pThis, unsigned nPosX, unsigned nPosY,
			  TScreenColor Color);
TScreenColor ScreenDeviceGetPixel(TScreenDevice *pThis, unsigned nPosX,
				  unsigned nPosY);

...
#else
#define ARM_IO_BASE (0x3F000000 + KERNEL_VADDR)
#endif

#define GPU_IO_BASE (0x7E000000 + KERNEL_VADDR)

#define GPU_CACHED_BASE   (0x40000000 + KERNEL_VADDR)
#define GPU_UNCACHED_BASE (0xC0000000 + KERNEL_VADDR)

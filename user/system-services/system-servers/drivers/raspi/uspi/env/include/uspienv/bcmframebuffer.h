...
void BcmFrameBuffer(TBcmFrameBuffer *pThis, unsigned nWidth, unsigned nHeight,
		    unsigned nDepth);
void _BcmFrameBuffer(TBcmFrameBuffer *pThis);

void BcmFrameBufferSetPalette(TBcmFrameBuffer *pThis, u8 nIndex,
			      u16 nColor); // with Depth == 8 only

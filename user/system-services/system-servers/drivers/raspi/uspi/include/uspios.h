...
#define HZ \
	100 // timer ticks / second (set this to your timer interrupt frequency)
...
void *tmalloc(unsigned nSize); // result must be 4-byte aligned
void tfree(void *pBlock);

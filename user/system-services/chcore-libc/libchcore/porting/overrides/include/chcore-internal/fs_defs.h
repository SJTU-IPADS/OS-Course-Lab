...
enum fsm_req_type {
        ...
        FSM_REQ_NEW_NAMESPACE,
        FSM_REQ_DELETE_NAMESPACE,
};
...
/* For path related ops, their paths and client badges should organize in the same offset. */
struct fs_request {
        ...
        union {
                ...
                struct {
                        badge_t client_badge;
                        char path1[FS_REQ_PATH_BUF_LEN];
                        char path2[FS_REQ_PATH_BUF_LEN];
                } path_ops2;
                struct {
                        int paritition;
                        off_t offset;
                ...
                struct {
                        ...
                        /* **DO NOT** change the offset above. */
                        mode_t mode;
                } chmod;
                struct {
                        int fd;

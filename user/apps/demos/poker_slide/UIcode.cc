...
extern const int UI_WIDTH = 512;
extern const int UI_HEIGHT = 768;

//////////////////////// define widgets & map message ////////////////////////
enum WND_ID { ID_ROOT = 1, ID_PAGE1, ID_PAGE2, ID_PAGE3, ID_PAGE4, ID_PAGE5 };
...
{
        load_resource();
        s_display = new c_display(phy_fb,
                                  screen_width,
                                  screen_height,
                                  UI_WIDTH,
                                  UI_HEIGHT,
        ...
        s_root.connect(
                NULL, ID_ROOT, 0, 0, 0, UI_WIDTH, UI_HEIGHT, s_root_children);
...
{
        down ? s_root.on_touch(x, y, TOUCH_DOWN) :
               s_root.on_touch(x, y, TOUCH_UP);
}

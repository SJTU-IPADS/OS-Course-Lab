...
#define UNITY_PRINT_EXEC_TIME()                                         \
        {                                                               \
                UNITY_UINT execTimeMs = (Unity.CurrentTestStopTime      \
...
typedef enum {
        UNITY_DISPLAY_STYLE_INT =
                (UNITY_INT_WIDTH / 8) + UNITY_DISPLAY_RANGE_INT,
        ...
        UNITY_DISPLAY_STYLE_UINT =
                (UNITY_INT_WIDTH / 8) + UNITY_DISPLAY_RANGE_UINT,
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT(                              \
        expected, actual, num_elements, line, message)                 \
        UnityAssertEqualIntArray(UnityNumToPtr((UNITY_INT)(expected),  \
                                               (UNITY_INT_WIDTH / 8)), \
                                 (UNITY_INTERNAL_PTR)(actual),         \
                                 (UNITY_UINT32)(num_elements),         \
                                 (message),                            \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_PTR(                                    \
        expected, actual, num_elements, line, message)                       \
        UnityAssertEqualIntArray(UnityNumToPtr((UNITY_PTR_TO_INT)(expected), \
                                               (UNITY_POINTER_WIDTH / 8)),   \
                                 (UNITY_INTERNAL_PTR)(actual),               \
                                 (UNITY_UINT32)(num_elements),               \
                                 (message),                                  \
                                 (UNITY_LINE_TYPE)(line),                    \

...
#define LV_ITERATE_ROOTS(f)                                                    \
        LV_DISPATCH(f, lv_ll_t, _lv_timer_ll) /*Linked list to store the       \
                                                 lv_timers*/                   \
        ...
        LV_DISPATCH_COND(f,                                                    \
                         _lv_draw_mask_radius_circle_dsc_arr_t,                \
                         _lv_circle_cache,                                     \
                         LV_DRAW_COMPLEX,                                      \
                         1)                                                    \
        LV_DISPATCH_COND(f,                                                    \
        ...
        LV_DISPATCH_COND(                                                      \
                f, uint8_t *, _lv_font_decompr_buf, LV_USE_FONT_COMPRESSED, 1) \
